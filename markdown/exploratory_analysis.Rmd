...
This section deals with the exploratory analysis for the **English** EURLex dataset. Exploratory analysis over German corpus can be found in the [GitHub repository](https://github.com/suhitaghosh10/EurLexClassification/tree/master/reports)
...
We load the dataset using _mldr_ method.
...
We come to the end of the exploratory analysis over the English text and the MLD dataset. From the above analysis it seems term-incidence and tf-idf can be surmised to be discrimatory features for the problem, as related labels/categories share many terms/bigrams. Also the concurrence plot helped us in observing related categories share many instances.
