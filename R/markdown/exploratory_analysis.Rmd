...
```{r init, include=FALSE, eval=TRUE, echo=FALSE, warning=FALSE}
source("../../R/scripts/requirements.R")
```
...
init <- function(language) {
  ...
  print("english chosen")
    ...
    tfidfArffFileName <<- "../../output/tfidf_EN.arff" # name of tf-idf arff file (english)
    incArffFileName <<- "../../output/inc_EN.arff" # name of term incidence arff file (english)
    XMLFileName <<- "../../output/EN.xml" # name of the label mldr xml file (english)
  ...
  print("german chosen")
    ...
    tfidfArffFileName <<- "../../output/tfidf_DE.arff" # name of tf-idf arff file (german)
    incArffFileName <<- "../../output/inc_DE.arff" # name of term incidence arff file (german)
    tfidfXMLFileName <<- "../../output/DE.xml" # name of the label mldr xml file (german)
    XMLFileName <<- "../../output/DE.xml" # name of the label mldr xml file (german)
...
tokens_by_label %>% filter(
  label == "water_treatment_tag" |
  label == "wastewater_tag" |
  label == "pollution_control_tag" |
  label == "atmospheric_pollution_tag" |
  label == "fight_against_unemployment_tag"
  ) %>%
...
tokens_by_label <- bind_tf_idf(book_words_eurlex, word, label, n) #enerates tf-idf and binds to dataframe
tokens_by_label
```
...
#corpus of text
text_corpus <- VCorpus(VectorSource(text_corpus))
