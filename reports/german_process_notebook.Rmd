...
sample_no <- ifelse((exists("doc_number") && doc_number>10), doc_number, length(raw_text_char))
...
knn_inc_br_red_results <- classify(incFileName,"br","KNN", TRUE)
rf_inc_br_red_results <- classify(incFileName,"br","RF", TRUE)
xgb_inc_br_red_results <- classify(incFileName,"br","XGB", TRUE)

knn_inc_lp_red_results <- classify(incFileName,"lp","KNN", TRUE)
rf_inc_lp_red_results <- classify(incFileName,"lp","RF", TRUE)
xgb_inc_lp_red_results <- classify(incFileName,"lp","XGB", TRUE)
